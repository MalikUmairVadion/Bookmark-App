...
This project is built using [NestJS](https://nestjs.com/) as a backend framework. Below is an overview of the all key modules and features included in the application:
